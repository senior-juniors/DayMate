...
fun DashboardGridSection() {
    val gridItems = listOf(
        Feature("Events", R.drawable.enjoy_img, Color(0xFFD0D1FF), Color(0xFFB1B2FF), Color(0xFF9293F0)),
        Feature("Clubs Meeting", R.drawable.group_study, Color(0xFFFFEDC2), Color(0xFFFFDD95), Color(0xFFE6C76F)),
        Feature("Study Material", R.drawable.enjoy_img, Color(0xFFAEE5D4), Color(0xFF98D7C2), Color(0xFF77C6A8)),
        Feature("Canteen", R.drawable.group_study, Color(0xFFFFD1D3), Color(0xFFFFB6B9), Color(0xFFE59497))
    )
...
//@Preview
//@Composable
//private fun DashboardScreenpre() {
